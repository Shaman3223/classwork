...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<AddSomeNumbers.SampleSyntaxAnalyzer,
        AddSomeNumbers.SampleCodeFixProvider>;

namespace AddSomeNumbers.Tests;
